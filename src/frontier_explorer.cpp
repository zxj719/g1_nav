...
private:
    ...
    const std::pair<double, double> & robot_xy)
  {
    ...
    return g1_nav::FrontierSearch::revalidate_nearby_frontier(
  ...
  const g1_nav::GvdData & get_gvd_data()
  {
    static const g1_nav::GvdData empty_gvd;
    if (!map_msg_) {
      return empty_gvd;
    }
    ...
    {
      auto built = g1_nav::GvdMap::build(grid, gvd_config_);
      RCLCPP_INFO(
    ...
    bool force_reach_anchor = false)
  {
    ...
    const auto snapped = g1_nav::GvdMap::snap_to_same_component_gvd(
    ...
    if (!snapped_anchor.found) {
      ...
      if (expanded_snap_radius > gvd_config_.snap_radius + 1e-3) {
        snapped_anchor = g1_nav::GvdMap::snap_to_same_component_gvd(
    ...
    const auto gvd_path = g1_nav::GvdMap::find_path(
    ...
    const std::pair<double, double> & frontier_xy)
  {
    ...
    const auto direct_path = g1_nav::GvdMap::find_safe_direct_goal(
  ...
  void make_plan()
  {
    ...
    auto frontiers = g1_nav::FrontierSearch::search(
    ...
    if (frontiers.empty() && !current_frontier_) {
      ...
      frontiers = g1_nav::FrontierSearch::search(
      ...
      !expanded_frontier_search)
    {
      auto global_frontier_config = frontier_search_config_;
      global_frontier_config.frontier_update_radius = 0.0;
      const auto global_frontiers = g1_nav::FrontierSearch::search(
        grid, *robot_xy, gvd_data.dist_map, global_frontier_config);
  ...
  std::optional<g1_nav::GvdData> gvd_data_;
